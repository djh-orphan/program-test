...
class CanlenFrame:
    ...
    def __init__(self, master):
        ...
        self.button1.place(x=290, y=350, width=30, height=30)
        self.button2 = Button(self.frame1, text='<', command=self.sub)
        self.button2.place(x=0, y=350, width=30, height=30)
        ...
        self.button5 = Button(self.frame1, text='切换', command=self.change)
        self.button5.place(x=135, y=400, width=30, height=30)
    def plus(self):
